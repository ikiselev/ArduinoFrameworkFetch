...
if [ ! -d ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES} ]; then mkdir ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES}; fi
...
rm -rf ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES}/*
...
#Install libraries
unzip ${ARDUINO_FILENAME} ${ARDUINO_LIBRARIES_PATH}/* -d ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES} >> /dev/null
mv -f ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES}/${ARDUINO_LIBRARIES_PATH}/* ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES}/
rm -rf ${ARDUINO_INSTALL_PATH}/${ARDUINO_LIBRARIES}/${ARDUINO_APP_NAME}
